...
<h2 align="center">Form Edit Pegawai</h2>
<form method="POST" action="{{url('admin/pegawai/update/')}}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text" name="nip" type="text" class="form-control" value="{{$p->nip}}">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="text5" class="col-4 col-form-label">Kekayaan</label> 
    <div class="col-8">
    <input id="text5" name="kekayaan" type="text" class="form-control" value="{{$p->kekayaan}}">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div>
    @empty($p->foto)
    <img src="{{url('admin/image/nofoto.jpg')}}" width="30%">
    @else
    <img src="{{url('admin/image')}}/{{$p->foto}}" width="30%">
    @endempty
    </div>
    </div>
